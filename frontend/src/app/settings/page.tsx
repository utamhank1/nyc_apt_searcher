...
export default function SettingsPage() {
  ...
  useEffect(() => {
    ...
    api.get<SearchConfig>("/api/v1/config").then(setConfig).catch(console.error);
  }, []);
            ...
            <Card className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setConfig({ ...config, max_price: parseInt(e.target.value) || 0 })}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    type="number"
                    min={0}
                    value={config.min_beds}
                    onChange={(e) => setConfig({ ...config, min_beds: parseInt(e.target.value) || 0 })}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    min={0}
                    step={0.5}
                    value={config.min_baths}
                    onChange={(e) => setConfig({ ...config, min_baths: parseFloat(e.target.value) || 0 })}
                  />
                </div>
              </div>
                ...
                <div className="space-y-3 mt-2">
                  {["streeteasy", "zillow"].map((source) => (
                    <div key={source} className="flex items-center justify-between">
                      <span className="capitalize font-medium">{source === "streeteasy" ? "StreetEasy" : "Zillow"}</span>
                      <Switch
                        checked={config.sources_enabled[source] ?? true}
                        onCheckedChange={(checked) =>
                          setConfig({
                            ...config,
                            sources_enabled: { ...config.sources_enabled, [source]: checked },
                          })
                        }
                      />
                    </div>
              ...
              <div>
                ...
                <Input
                  ...
                  value={config.work_address}
                  onChange={(e) => setConfig({ ...config, work_address: e.target.value })}
                  className="mt-2"
                />
              </div>
            </Card>
            ...
            <Card className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 gap-3 mt-2">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setConfig({ ...config, user_phone: e.target.value })}
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mb-2">
                  Click to connect, then send /start to the bot to get your chat ID
                </p>
                <a href="https://t.me/your_bot" target="_blank" rel="noopener noreferrer">
                  <Button variant="outline">Connect Telegram Bot</Button>
                </a>
              </div>
          ...
          <TabsContent value="template">
            <Card className="p-6 space-y-6">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  checked={config.use_custom_email_template}
                  onCheckedChange={(checked) =>
                    setConfig({ ...config, use_custom_email_template: checked })
                  }
                />
              </div>
              ...
              {config.use_custom_email_template && (
                <>
                  ...
                  <div>
                    ...
                    <Input
                      value={config.custom_email_subject}
                      onChange={(e) => setConfig({ ...config, custom_email_subject: e.target.value })}
                  ...
                  <div>
                    ...
                    <Textarea
                      value={config.custom_email_body}
                      onChange={(e) => setConfig({ ...config, custom_email_body: e.target.value })}
                      rows={12}
                      className="font-mono text-sm"
                    />
                  </div>
